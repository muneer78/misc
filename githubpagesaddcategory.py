...
def update_markdown_files(directory, file_tag_map):
    ...
    for filename, tags in file_tag_map.items():
        ...
        if os.path.isfile(filepath) and filepath.endswith('.md'):
            ...
            # Combine the existing content with the text to add
            new_content = text_to_add + existing_content
...
if __name__ == "__main__":
    ...
    csv_filepath = '/Users/muneer78/Desktop/updated_file-cats.csv'  # Set the CSV file path here
