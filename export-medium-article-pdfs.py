...
pdfkit_config = pdfkit.configuration(
    wkhtmltopdf="/Users/muneer78/project/.venv/lib/python3.11/site-packages/pdfkit"
...
response = requests.get(
    READING_LIST_URL, headers=HEADERS, cookies={"your_cookie_name": "your_cookie_value"}
)
...
for i, link in enumerate(article_links):
    ...
    if article_response.status_code == 200:
        ...
        print(
            f"Failed to fetch article: {link} (Status: {article_response.status_code})"
        )
