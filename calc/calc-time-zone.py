...
time_zones = [
    ...
    ("US/Eastern", "EST", "Orlando & Toronto"),
...
input_datetime_str = input(
    "Enter the date and time in Central Time (YYYY-MM-DD HH:MM AM/PM): "
)
...
for tz_name, tz_abbr, city_name in time_zones:
    ...
    formatted_time = converted_time.strftime("%I:%M%p").lstrip(
        "0"
