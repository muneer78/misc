...
with pd.ExcelWriter(output_file, engine='xlsxwriter') as writer:
    ...
    write_dataframe_with_title(writer, grouped_leads, "Grouped Leads Dataframe", "Lead Assignments", 0, 0)
    write_dataframe_with_title(writer, grouped_newopps, "Grouped New Opps Dataframe", "New Opps Assignments", 0, 0)
    write_dataframe_with_title(writer, grouped_reassignops, "Grouped Reassign Opps Dataframe", "Reassign Opps Assignments", 0, 0)
