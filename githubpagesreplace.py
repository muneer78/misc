...
def update_markdown_files(directory):
    ...
    for filename in os.listdir(directory):
        if filename.endswith('.md'):
            ...
            updated_content = re.sub(categories_pattern, 'tags', content)
...
if __name__ == "__main__":
    directory = '/Users/muneer78/Documents/GitHub/muneer78.github.io/_posts/'  # Set your specific directory here
