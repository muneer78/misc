...
folder_path = '/Users/muneer78/EagleFiler/Main/images/Files/'  # Replace with your folder path
...
for filename in os.listdir(folder_path):
    ...
    if ' ' in filename or '--' in filename:
        ...
        # Remove special characters, but keep alphanumeric, dashes, underscores, and periods
